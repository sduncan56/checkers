An online multiplayer implementation of Checkers. Players can add contacts and challenge them to games. Scores and other account details are stored in a database on the server.
